    ...
    <Section id="how-to-use">
      <div className="container">
        ...
        <div className="relative">
          {/* First service */}
          <div className="relative z-1 flex items-center h-[39rem] mb-5 p-8 border boder-n-1/10 rounded-3xl overflow-hidden lg:p-20 xl:h-[46rem]">
            <div className="absolute top-0 left-0 w-full h-full pointer-events-none md:w-3/5 xl:w-auto">
              <img
                className="w-full h-full object-cover mb:object-right"
                width={800}
                height={730}
                src={service1}
                alt=""
            ...
            <div className="relative z-1 max-w-[17rem] ml-auto">
              ...
              <p className="body-2 mb-[3rem] text-n-3">
                Brainwave unlox the potential of AI-powered applications
              </p>
              <ul className="body-2">
